...
QC_summary <- read_csv("./data/MultiQCs_MetaPocillopora_012022.csv") %>% filter(`Study` != "ConnellyEAPSI")
sum(QC_summary$`Raw Reads`)
# 1.72 billion reads as of 01/20/2022
```
```{r tidydata}
...
ggsave(qcfig, filename = "./outputs/figures/Fig1_pipelineQC.pdf", width = 8, height = 4, units = "in", device = "pdf")
```
