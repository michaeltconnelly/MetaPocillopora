...
```{r factor levels}
study_factor <- c("Vidal-Dupiol2014", "Yuan2017", "Zhou2017", "Brener-Raffali2018", "Tang2018", "Wecker2018", "Zhou2018", "Poquita-Du2019", "Zhou2019", "ConnellyEAPSI", "Chuang-Mitarai2020")
```
...
countdata_sorted_coral <- as.data.frame(countdata[sort(rownames(countdata)), order(match(colnames(countdata),row.names(coldata)))]) 
```
...
```
```{r}
pdf("./outputs/figures/gene_expression_pca.pdf")
