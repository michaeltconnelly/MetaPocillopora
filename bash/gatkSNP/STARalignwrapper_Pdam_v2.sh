...
#~/scripts/EAPSI.HW-WT-master/STARalignwrapper_Pdam_v2.sh
#/scratch/projects/transcriptomics/mikeconnelly/scripts/EAPSI.HW-WT-master/STARalignwrapper_Pdam_v2.sh
